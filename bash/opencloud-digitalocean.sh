...
#do服务器位置
region_do(){
    json=`cat <(curl -Ls https://raw.githubusercontent.com/jasoduncan/open_cloud/main/digitalocean/region)`
...
#do服务器大小
size_do(){
    json=`cat <(curl -Ls https://raw.githubusercontent.com/jasoduncan/open_cloud/main/digitalocean/size)`
    o=`echo $json| jq ".opencloud | length"`
...
#do服务器镜像
image_do(){
    json=`cat <(curl -Ls https://raw.githubusercontent.com/jasoduncan/open_cloud/main/digitalocean/image)`
    o=`echo $json| jq ".opencloud | length"`
